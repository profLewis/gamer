...
struct FAQData {
    ...
    static let shops = FAQCategory(title: "Shops & Gold", contexts: ["shop", "exploration"], entries: [
        ...
        FAQEntry(
            ...
            answer: "Many screens wait for a tap so you can read them; with Auto-Continue on (the default) they also move on after the Info Timeout. To hold them, tap the little hourglass beside the > prompt while a screen is counting down (it turns amber and says paused) — or press Space on a Mac. Tap it again to carry on; long-press it to hurry things along. To turn it off for good, go to Settings > Gameplay > Auto-Continue Off, or change how long screens wait with Info Timeout.",
