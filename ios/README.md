...
- Auto-Continue with a countdown hourglass by the `>` prompt: tap anywhere to move on, wait for it to run out, tap it to pause (orange = paused), long-press to hurry (see *Auto-Continue* under Gameplay)
