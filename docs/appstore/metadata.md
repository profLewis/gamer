...
• Speak instead of typing: press the microphone once and give commands one after another.
• Turn on Read Aloud and the DM narrates everything, with different voices for your companions.
...
• Adjustable text size, left- or right-handed layout, reduced animations, pausable timers, and help on every screen.
...
- **Category:** Games → Role Playing (secondary: Games → Adventure)
- **Support URL:** https://github.com/profLewis/gamer/issues
- **Marketing URL:** https://github.com/profLewis/gamer
