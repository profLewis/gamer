  ...
  "monsters": [
    {
      ...
      "name": "Giant Rat",
      "source": "Bestiary",
      "description": "An oversized dungeon rat with diseased fangs, twitching whiskers, and eyes that shine red in torchlight. It lives in filth, feeds on scraps, and attacks in hungry packs. In close tunnels, giant rats overwhelm isolated adventurers by sheer relentless numbers.",
      "stats": {
        "HP": 4,
        "AC": 10,
        "ATK": "+2",
    ...
    },
    {
      ...
      "name": "Kobold",
      "source": "Bestiary",
      "description": "A wiry reptilian tunnel-fighter clutching crude weapons and a bag of traps. Kobolds avoid fair fights, preferring ambushes, falling rubble, and narrow kill corridors. Individually weak but collectively dangerous, they excel at turning terrain into a weapon.",
      "stats": {
        "HP": 5,
        "AC": 12,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Stirge",
      "source": "Bestiary",
      "description": "A bat-sized blood-feeder with a needle beak and frantic membrane wings. It darts unpredictably, latches onto exposed flesh, and drinks until forced away. A stirge attack creates panic because every second attached drains life and action economy.",
      "stats": {
        "HP": 2,
        "AC": 13,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Giant Bat",
      "source": "Bestiary",
      "description": "A cavern predator with a broad wingspan, hooked claws, and a sudden diving bite. It hunts by echo and darkness, harassing from overhead where melee fighters struggle to respond. Giant bats are most dangerous in swarms and broken vertical terrain.",
      "stats": {
        "HP": 4,
        "AC": 11,
        "ATK": "+2",
    ...
    },
    {
      ...
      "name": "Crawling Claw",
      "source": "Bestiary",
      "description": "A severed hand animated by spiteful necromancy, skittering across stone on finger joints. It hides in cracks, reaches through bars, and strikes at throats or lantern hands. Small and eerie, it is less a brute threat and more a fear multiplier.",
      "stats": {
        "HP": 3,
        "AC": 12,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Goblin",
      "source": "Bestiary",
      "description": "A vicious raider with sharp teeth, quick reflexes, and a cruel survival instinct. Goblins pepper enemies from cover, retreat when challenged, and re-engage when advantage returns. Their threat comes from dirty coordination, not honorable dueling.",
      "stats": {
        "HP": 7,
        "AC": 13,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Skeleton",
      "source": "Bestiary",
      "description": "A rattling warrior of animated bone carrying rusted steel and no memory of mercy. It does not tire, fear, or negotiate, and it keeps advancing until shattered apart. Skeletons punish parties that rely on intimidation or morale-breaking tactics.",
      "stats": {
        "HP": 10,
        "AC": 12,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Zombie",
      "source": "Bestiary",
      "description": "A shambling corpse bound to necrotic hunger and stubborn dark magic. It moves slowly but absorbs punishment that would drop living enemies instantly. Zombies are terrifying in attrition fights where space is tight and retreat routes are blocked.",
      "stats": {
        "HP": 15,
        "AC": 8,
        "ATK": "+2",
    ...
    },
    {
      ...
      "name": "Wolf",
      "source": "Bestiary",
      "description": "A lean pack hunter with bright eyes, powerful jaws, and relentless pursuit instincts. Wolves circle to isolate weaker prey, then strike in coordinated bursts. Their true danger appears when terrain or weather favors ambush and mobility.",
      "stats": {
        "HP": 8,
        "AC": 12,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Orc",
      "source": "Bestiary",
      "description": "A brutal frontline warrior marked by scars, tusks, and battlefield aggression. Orcs favor decisive charges and heavy weapon blows meant to break lines quickly. They are most effective when led by a dominant commander and given room to rush.",
      "stats": {
        "HP": 15,
        "AC": 13,
        "ATK": "+5",
    ...
    },
    {
      ...
      "name": "Hobgoblin",
      "source": "Bestiary",
      "description": "An armored goblinoid soldier drilled for war, formation discipline, and tactical punishment. Hobgoblins exploit openings immediately and maintain pressure without losing structure. Against careless parties, they feel less like monsters and more like a veteran military unit.",
      "stats": {
        "HP": 11,
        "AC": 16,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Gnoll",
      "source": "Bestiary",
      "description": "A hyena-headed marauder driven by bloodlust, carrion hunger, and feral glee. Gnolls fight noisily and aggressively, feeding off chaos and fear in equal measure. They thrive in raids, where broken lines and panic become part of their strategy.",
      "stats": {
        "HP": 18,
        "AC": 14,
        "ATK": "+4",
    ...
    },
    {
      ...
      "name": "Rust Monster",
      "source": "Bestiary",
      "description": "A chitinous scavenger with twitching antennae that oxidize and consume metal at touch range. It is dreaded not for raw damage, but for how fast it destroys equipment and confidence. A rust monster encounter can rewrite a party's plan in one round.",
      "stats": {
        "HP": 27,
        "AC": 14,
        "ATK": "+3",
    ...
    },
    {
      ...
      "name": "Bugbear",
      "source": "Bestiary",
      "description": "A hulking goblinoid ambusher wrapped in matted fur, stealth, and sudden violence. Bugbears strike from concealment with surprising reach and crushing first hits. They are ideal shock troops for lairs that rely on darkness and deception.",
      "stats": {
        "HP": 27,
        "AC": 16,
        "ATK": "+4",
    ...
    },
    {
      ...
      "name": "Giant Spider",
      "source": "Bestiary",
      "description": "A massive web-spinner with venomous fangs and patient predatory intelligence. It hunts from ceilings, shadows, and web-choked chokepoints that restrict movement. Once prey is restrained, the spider shifts from skirmish threat to executioner.",
      "stats": {
        "HP": 26,
        "AC": 14,
        "ATK": "+5",
    ...
    },
    {
      ...
      "name": "Ogre",
      "source": "Bestiary",
      "description": "A towering giant brute with immense muscles, thick hide, and a club like a felled tree. Ogres are simple but catastrophically strong, capable of ending fragile heroes with one impact. Their weakness is poor finesse, not lack of threat.",
      "stats": {
        "HP": 59,
        "AC": 11,
        "ATK": "+6",
    ...
    },
    {
      ...
      "name": "Gargoyle",
      "source": "Bestiary",
      "description": "A winged stone predator that can pose as carved architecture for hours without moving. When battle begins, it dives with claws and fangs while shrugging off lesser blows. Gargoyles dominate ruined keeps, belfries, and cursed rooftops.",
      "stats": {
        "HP": 52,
        "AC": 15,
        "ATK": "+4",
    ...
    },
    {
      ...
      "name": "Mimic",
      "source": "Bestiary",
      "description": "A shapechanger that imitates chests, doors, and dungeon furnishings with alarming accuracy. It waits for greed or curiosity, then traps prey with adhesive flesh and crushing jaws. Mimics turn safe assumptions into lethal mistakes.",
      "stats": {
        "HP": 58,
        "AC": 12,
        "ATK": "+5",
    ...
    },
    {
      ...
      "source": "Bestiary",
      "description": "A near-invisible wall of acidic jelly sliding silently through corridors and crypt aisles. It engulfs creatures whole, dissolves gear, and weaponizes narrow architecture. Parties lose to cubes when they stop checking line-of-sight and floor depth.",
      "stats": {
        "HP": 84,
        "AC": 6,
        "ATK": "+4",
    ...
    },
    {
      ...
      "name": "Owlbear",
      "source": "Bestiary",
      "description": "A monstrous hybrid of owl and bear - all talons, beak, fur, and unfiltered rage. Its hunting cry can rattle nerves before the first strike even lands. Once an owlbear commits to a charge, it mauls through armor with terrifying momentum.",
      "stats": {
        "HP": 59,
        "AC": 13,
        "ATK": "+7",
    ...
    },
    {
      ...
      "name": "Troll",
      "source": "Bestiary",
      "description": "A long-limbed horror with tearing claws, rancid breath, and flesh that knits itself back together. Trolls keep fighting through wounds that would kill almost anything else. Without fire or acid, victory can collapse into a brutal stalemate.",
      "stats": {
        "HP": 84,
        "AC": 15,
        "ATK": "+7",
    ...
    },
    {
      ...
      "name": "Minotaur",
      "source": "Bestiary",
      "description": "A bull-headed juggernaut bred for slaughter in corridors, arenas, and labyrinth halls. It reads terrain instinctively, using corners and lanes to set devastating charges. Minotaurs are not subtle, but they are brutally efficient predators.",
      "stats": {
        "HP": 76,
        "AC": 14,
        "ATK": "+6",
    ...
    },
    {
      ...
      "name": "Basilisk",
      "source": "Bestiary",
      "description": "A thick-scaled reptile with cold eyes and a gaze that petrifies flesh into stone. It advances with predatory patience, forcing heroes to choose between looking and dying. Basilisk encounters are won through discipline, mirrors, and nerves.",
      "stats": {
        "HP": 52,
        "AC": 15,
        "ATK": "+5",
    ...
    },
    {
      ...
      "name": "Wraith",
      "source": "Bestiary",
      "description": "A shadow-wrapped undead spirit that glides soundlessly and drains life at a touch. It carries an aura of dread that weakens resolve before blades even meet. Wraiths turn victory sour by leaving survivors exhausted, chilled, and hollow.",
      "stats": {
        "HP": 67,
        "AC": 13,
        "ATK": "+6",
    ...
    },
    {
      ...
      "name": "Young Dragon",
      "source": "Bestiary",
      "description": "A juvenile dragon already large enough to shatter shields with claw, fang, and breath weapon. Proud and territorial, it probes enemies before committing to lethal aggression. Underestimating a young dragon is usually a one-fight lesson.",
      "stats": {
        "HP": 142,
        "AC": 18,
        "ATK": "+10",
